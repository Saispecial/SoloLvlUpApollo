...
export function AchievementsPanel({ achievements, completedQuests = [] }: AchievementsPanelProps) {
  ...
  const difficultyColors: Record<string, string> = {
    ...
    Advanced: "bg-red-500",
    "Professional Milestone": "bg-purple-500",
  }

  const typeColors: Record<string, string> = {
    "Daily Reflection": "bg-blue-500",
    "Training Module": "bg-gray-500",
    "Weekly Challenge": "bg-green-500",
    "Professional Goal": "bg-purple-500",
  }
